...
const Hero = () => {
  ...
  return (
    <section className="h-screen md:h-auto  m-0 p-0  relative ">
      ...
      <div className=" w-full z-20 top-[100%] absolute -translate-y-[210%] xs:-translate-y-[140%]  lg:-translate-y-[100%] xl:-translate-y-[95%]">
        ...
        <div className=" absolute top-[100%] z-30 w-full ">
          <div className="flex flex-col inside-container relative bottom-8 sm:bottom-16 md:bottom-20 items-center lg:items-start lg:justify-center ">
