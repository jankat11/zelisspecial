...
const IntroductionItem = ({ introImage, title }) => {
  return (
    <div
      className={`md:aspect-[10/9] group md:relative containerss md:overflow-hidden aspect-square`}
    >
      <Image
        src={introImage}
        width={900}
        height={900}
        alt="plates"
        className="four-images absolute md:relative object-cover object-center aspect-square home-prod-img"
      />
